...
:scdf-release-train-name: Bacon
:app-import-kafka-maven: http://bit.ly/{scdf-release-train-name}-RELEASE-stream-applications-kafka-10-maven
:app-import-rabbit-maven: http://bit.ly/{scdf-release-train-name}-RELEASE-stream-applications-rabbit-maven
