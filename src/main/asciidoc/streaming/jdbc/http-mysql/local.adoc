...
* Running instance of link:https://www.mysql.com/[MySQL]
* A database utility tool such as link:https://dbeaver.jkiss.org/[DBeaver] or link:https://www.dbvis.com/[DbVisualizer]
